...
const About = () => {
  ...
  <div className="absolute left-1/2 top-1/2 h-1 w-[90%] -translate-x-1/2 -translate-y-1/2 transform bg-[#64ffda] rounded-full 
    ...
    <p>
      ...
      improves user experiences and solves real-world problems.
        ...
        <div className="flex flex-col gap-10 sm:flex-row sm:flex-wrap">
          {/* First Row */}
          <div className="flex flex-col sm:flex-row sm:w-full sm:gap-10">
            <motion.div
              className="sm:w-1/2"
              initial={{ opacity: 0, x: -100 }}
              whileInView={{ opacity: 1, x: 0 }}
            ...
            >
              ...
              <p className="text-lg">Sparklin | Jan 2024 - April 2024</p>
            ...
            >
              ...
              <p className="text-lg">Zemoso Technologies | March 2023 - October 2023</p>
              <ul className="list-disc list-inside">
                <li>
          ...
          <div className="flex flex-col sm:flex-row sm:w-full sm:gap-10">
            ...
            >
              ...
              <p className="text-lg">SplashLearn | June 2022 - Dec 2022</p>
              <ul className="list-disc list-inside">
                <li>
                  {" "}
            ...
            >
              ...
              <p className="text-lg">SplashLearn | Jan 2022 - June 2022</p>
              <ul className="list-disc list-inside">
                <li>
